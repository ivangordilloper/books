                        ...
                        <table class="letraC">
                            ...
                            <g:each in="${libros}" var="libro">
                                <tr>
                                    ...
                                    <td style="padding: 5px; color:#666666"> <p class="delete" id="${libro.id}" style="Margin-top: 14px;"><g:img dir="images" file="eliminar.png" align="right" class="image-list3" /></p></td>
                                </tr>
                            </g:each>
