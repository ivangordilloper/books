                ...
                <td>
                    <div class="dropdown">
                        <div id="myDropdown" class="dropdown-content">
                            <a href="${createLink(controller : 'perfilAdministrador', action:'verListaLibro', params: [id: lista.id])}" style="font-size: 13px;">Ver</a>
                        </div>
                    </div>
                    ...
                    <td>
                        <div class="dropdown">
                            <div id="myDropdown2" class="dropdown-content">
                                <a href="${createLink(controller : 'perfilAdministrador', action:'verListaAutor', params: [id: lista.id])}" style="font-size: 13px;">Ver</a>
                          </div>
                        </div>
...
<g:each in="${usuarioBusqueda.amigos}" var="amigo">
        <ul class="list-group" style="padding-top: 20px;" >
            <li class="list-group-item"  style="border: transparent; border-color: transparent;">
